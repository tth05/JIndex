...
use crate::jni::{get_java_lang_object, is_basic_signature_type, with_jni_env};
...
pub unsafe extern "system" fn Java_com_github_tth05_jindex_IndexedClass_getFieldsNative(
    ...
    with_jni_env!(env, {
        ...
        let result_class = env
            .find_class(jni_str!("com/github/tth05/jindex/IndexedField"))
...
pub unsafe extern "system" fn Java_com_github_tth05_jindex_IndexedClass_findImplementationsNative(
    ...
    with_jni_env!(env, {
        ...
        let classes: Vec<_> =
            class_index.find_implementations_of_class(indexed_class.index(), direct_sub_types_only);
